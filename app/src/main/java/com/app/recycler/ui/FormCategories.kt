...
class FormCategories(val context: Context, var arrayList: ArrayList<DummyData>, var listener:ListingItemClick) : RecyclerView.Adapter<FormCategories.MyViewHolder>() {
